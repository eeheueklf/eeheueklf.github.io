...
function HomepageHeader() {
  ...
  return (
    <div className="spaceCoverWrapper">
      <SpaceCover />
      <div className="container spaceCoverContent">
        <header className="heroBanner heroBannerDark">
        ...
        <main>
          ...
          <section className="container">
            ...
            <ul className="contact-list">
              ...
              <li>
                <Link to="mailto:eeheueklf@gmail.com" className="contact-link">
                  <span className="link-icon"><LinkIcon /></span>
                  eeheueklf@gmail.com
                </Link>
              </li>
